...
#          "Indicadores",
      sidebarPanel = bsplus::bs_collapse(
        ...
        content = sidebarPanel(
          ...
          tags$br(),
          uiOutput("corte_cid"),
          div(bs_button(icon("kit-medical"),button_type="default")%>%bs_attach_collapse("diagdet")),
          checkboxInput("capitulo","CID Sec."),
          bs_collapse(id = "diagdet",content = uiOutput("destaque_diagnostico")),
