...
aih_piccolo <- readRDS("/home/borges/pRojetos/pnrf/dados/aih_piccolo.rds")
...
# tipos_leitos <- read_csv("/home/borges/pRojetos/pnrf/dados/sigtap_leitos.csv", col_names = F)[[1]]
# names(tipos_leitos) <- janitor::make_clean_names(read_csv("/home/borges/pRojetos/pnrf/dados/sigtap_leitos.csv", col_names = F)[[2]])
...
lista_proced_base <- readRDS("/home/borges/pRojetos/pnrf/dados/lista_procedimentos.rds")

#source("R/paletas.R")
#source("R/regioes_de_saude.R")
#source("RR/processamento_inicial.R")

grupo <- read_csv2("/home/borges/pRojetos/pnrf/dados/grupos_proced.csv")
names(grupo$CO_GRUPO) <- grupo$NO_GRUPO
grupo <- grupo$NO_GRUPO
subgrupos <- readRDS("/home/borges/pRojetos/pnrf/dados/subgrupos.rds")
...
#monextradrac <- read_xlsx("/home/borges/pRojetos/pnrf/dados/propostas_mon/2023-02-24-monextra-drac.xlsx",skip=2)
...
aih_por_uf <- readRDS("/home/borges/pRojetos/pnrf/dados/aih_pnrf_por_uf.rds")
# cnesval <- readRDS("/home/borges/pRojetos/pnrf/dados/2023-01-10-cnes_validos.rds")
#
# aih <- readRDS("/home/borges/pRojetos/pnrf/dados/aih_2018_202301_pnrf.rds")
#
